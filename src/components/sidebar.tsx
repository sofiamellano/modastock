  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        <nav className="p-4">
          <div className="mb-8">
            <p className={`sidebar-text uppercase text-xs font-semibold text-indigo-300 mb-4 ${collapsed ? "hidden" : ""}`}>
              Principal
            </p>
            <ul>
              <li>
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault()
                    onNavigate("panel") // ✅ CAMBIADO de "dashboard" a "panel"
                  }}
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "panel" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
            ...
            <ul>
              <li>
                <a
                  ...
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "registrarPrenda" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
              ...
              <li>
                <a
                  ...
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "registrarVenta" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
              ...
              <li>
                <a
                  ...
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "mayoristas" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
            ...
            <ul>
              <li>
                <a
                  ...
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "inventario" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
              ...
              <li>
                <a
                  ...
                  className={`flex items-center py-2 px-3 rounded-lg ${
                    activeSection === "historialVentas" ? "bg-indigo-700 text-white" : "hover:bg-indigo-700 text-white"
                  } mb-2`}
                >
